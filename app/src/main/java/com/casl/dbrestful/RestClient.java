...
public class RestClient {
    ...
    // "http://chinesehealthyaging.org/chapRest/";
    //"http://ec2-18-185-23-48.eu-central-1.compute.amazonaws.com:8080/";
    private static AsyncHttpClient client = new AsyncHttpClient();
    private static SyncHttpClient syncClient = new SyncHttpClient();
    //    private static String username="staff73";
//    private static String password="41roufo";
    private static String username = "staff54";
    private static String password = "ya7rad";
